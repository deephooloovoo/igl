...
void
_deletemsliderbar(Actuator *a,Actuator *sa)
{
...
void
setsubactextval(Actuator *a, Actuator *sa, Coord x, float dist)
{
  Actuator *sb;
  Multislider *ad=(Multislider *)a->data;
  float tmp;
...
void _newvalvmultislider(Actuator *a,Panel *p,Coord x,Coord y)
{    
  Multislider *ad=(Multislider *)a->data;
  Actuator *sa;
  float tmp;
...
void _newvalhmultislider(Actuator *a,Panel *p,Coord x,Coord y)
{    
  Multislider *ad=(Multislider *)a->data;
  Actuator *sa;
  float tmp;
...
void
_newvalmsliderbar(Actuator *a,Panel *p,Coord x,Coord y)
{    
  (void) fprintf (stdout,"_newvalmsliderbar for %s called: x=%f, y=%f\n",
	 (a->label?a->label:"(nil)"), x, y);
  pnl_setdirty(a);
}

void
  setclearregion(Actuator *a)
{
  Actuator *sa;
  Multislider *ad=(Multislider *)a->data;
...
void
_drawmultislider(Actuator *a, Panel *p)
{
  Multislider *ad=(Multislider *)a->data;
  Actuator *sa;
  ...
  for (sa=a->al;sa;sa=sa->next) {
#ifdef DEBUG
    (void) fprintf (stdout,"drawing %s from _drawvmultislider\n", sa->label);
#endif
    pnl_drawact(sa, a->p);
  }
...
void
_drawmsliderbar(Actuator *a, Panel *p)
{
...
void
_drawmslideropenbar(Actuator *a, Panel *p)
{
  if (!a->dirtycnt) return;
...
void
pnl_vmultislider_bar(Actuator *a)
{
  pnl_button(a);
...
void
pnl_vmultislider_open_bar(Actuator *a)
{
...
void
pnl_hmultislider_bar(Actuator *a)
{
  pnl_button(a);
...
void
pnl_hmultislider_open_bar(Actuator *a)
{
