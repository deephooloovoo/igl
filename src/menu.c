...
_igl_X11createPopupMenu (igl_menuT *menu)
{
    ...
    wflags = CWBackPixel |CWColormap | CWEventMask | CWOverrideRedirect; /* | CWCursor; */
    ...
    swAttribs.colormap = XCreateColormap( igl->appInstance, RootWindow (igl->appInstance, igl->visualInfo.screen), igl->visualInfo.visual, AllocNone );
