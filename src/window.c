...
#   endif
    ...
    swAttribs.colormap = XCreateColormap( igl->appInstance, RootWindow (igl->appInstance, igl->visualInfo.screen),
                                      igl->visualInfo.visual, AllocNone );

    wflags = CWEventMask| CWColormap;
    Window parent = wptr->parentWnd != IGL_NULLWND ? wptr->parentWnd : RootWindow (igl->appInstance, igl->visualInfo.screen);
